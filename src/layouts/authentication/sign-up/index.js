                                ...
                                auth.user.updateProfile({
                                    ...
                                    db.collection('users').doc(auth.user.uid).set({
                                        ...
                                        emailSee:true,
                                          ...
                                          setLoading(false)
                                          swal("Succefully created Electrika account.\n\nThank you!")
                                          history('/')
...
/>
  ...
  <SoftInput type="text" value={idNo} onChange={e => setIdNo(e.target.value)} placeholder="National ID No."/>
    ...
    placeholder="Confirm Password" />
        ...
        <SoftBox mt={2} mb={1}>
          <SoftButton style={{backgroundColor:'#2152ff',color:'#fff'}} onClick={completeRegistration} variant="gradient" color="dark" fullWidth>
          {loading === true ?(
