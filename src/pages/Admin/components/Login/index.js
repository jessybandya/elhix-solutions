...
function SignIn() {
   ...
   setLoading(true)
    ...
    .then((auth) =>{
      ...
      Swal.fire({
        icon: 'success',
        title: 'Login Success',
        text: 'Welcome to Roophix Solutions Admin!',
  ...
  return (
    ...
    <center><img src="/media/images/logos/main-logo.jpg" style={{height:80, marginTop:50}}/></center>
    <center style={{fontWeight:'bold',margin:10,fontSize:18}}>Roophix Solutions Admin!</center>
